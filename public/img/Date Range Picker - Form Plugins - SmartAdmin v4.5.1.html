<!DOCTYPE html>
<!-- saved from url=(0087)https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <title>
            Date Range Picker - Form Plugins - SmartAdmin v4.5.1
        </title>
        <meta name="description" content="Date Range Picker">
        ...
        <!-- base css -->
        <link id="vendorsbundle" rel="stylesheet" media="screen, print" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/vendors.bundle.css">
        <link id="appbundle" rel="stylesheet" media="screen, print" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/app.bundle.css">
        <link id="mytheme" rel="stylesheet" media="screen, print" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html">
        <link id="myskin" rel="stylesheet" media="screen, print" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/skin-master.css">
        ...
        <link rel="stylesheet" media="screen, print" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/bootstrap-daterangepicker.css">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
	...
	-->
    <body class="mod-bg-1 mod-nav-link desktop chrome webkit mobile-view-activated pace-done blur"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
  <div class="pace-progress-inner"></div>
</div>
<div class="pace-activity"></div></div>
        <!-- DOC: script to save and load page settings -->
        <script async="" src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/analytics.js.download"></script><script>
            /**
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                    ...
                    <nav id="js-primary-nav" class="primary-nav js-list-filter" role="navigation">
                        <div class="nav-filter">
                            <div class="position-relative">
                                ...
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn-primary btn-search-close js-waves-off" data-action="toggle" data-class="list-filter-active" data-target=".page-sidebar">
                                    <i class="fal fa-chevron-up"></i>
                                </a>
                            </div>
                        </div>
                        <div class="info-card">
                            <img src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                            <div class="info-card-text">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-flex align-items-center text-white">
                            ...
                            <img src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/cover-2-lg.png" class="cover" alt="cover">
                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="pull-trigger-btn" data-action="toggle" data-class="list-filter-active" data-target=".page-sidebar" data-focus="nav_filter_input">
                                <i class="fal fa-angle-down"></i>
                            </a>
                        </div>
                        <ul id="js-nav-menu" class="nav-menu js-nav-built">
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Application Intel" data-filter-tags="application intel" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Theme Settings" data-filter-tags="theme settings" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Documentation" data-filter-tags="documentation" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="UI Components" data-filter-tags="ui components" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Utilities" data-filter-tags="utilities" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Font Icons" data-filter-tags="font icons" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Tables" data-filter-tags="tables" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Form Stuff" data-filter-tags="form stuff" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Plugins" data-filter-tags="plugins" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Datatables" data-filter-tags="datatables datagrid" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Statistics" data-filter-tags="statistics chart graphs" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Notifications" data-filter-tags="notifications" class=" waves-effect waves-themed">
                            ...
                            <li class="active open">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Form Plugins" data-filter-tags="form plugins" aria-expanded="true" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Miscellaneous" data-filter-tags="miscellaneous" class=" waves-effect waves-themed">
                            ...
                            <li>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" title="Pages" data-filter-tags="pages" class=" waves-effect waves-themed">
                    ...
                    <div class="nav-footer shadow-top">
                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" data-action="toggle" data-class="nav-function-minify" class="hidden-md-down">
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="hidden-md-down dropdown-icon-menu position-relative">
                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-btn btn js-waves-off" data-action="toggle" data-class="nav-function-hidden" title="Hide Navigation">
                                <i class="ni ni-menu"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="btn js-waves-off" data-action="toggle" data-class="nav-function-minify" title="Minify Navigation">
                                        <i class="ni ni-minify-nav"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="btn js-waves-off" data-action="toggle" data-class="nav-function-fixed" title="Lock Navigation">
                        ...
                        <div class="hidden-lg-up">
                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-btn btn press-scale-down waves-effect waves-themed" data-action="toggle" data-class="mobile-nav-on">
                                <i class="ni ni-menu"></i>
                            </a>
                        </div>
                        <div class="search">
                            <form class="app-forms hidden-xs-down" role="search" action="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/page_search.html" autocomplete="off">
                                ...
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn-danger btn-search-close js-waves-off d-none" data-action="toggle" data-class="mobile-search-on">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div class="hidden-sm-up">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-icon" data-action="toggle" data-class="mobile-search-on" data-focus="search-field" title="Search">
                                    <i class="fal fa-search"></i>
                                </a>
                            </div>
                            <!-- app settings -->
                            <div class="hidden-md-down">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-icon" data-toggle="modal" data-target=".js-modal-settings">
                                    <i class="fal fa-cog"></i>
                                </a>
                            </div>
                            <!-- app shortcuts -->
                            <div>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-icon" data-toggle="dropdown" title="My Apps">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated w-auto h-auto">
                                    ...
                                    <div class="custom-scroll h-100">
                                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><ul class="app-list" style="overflow: hidden; width: auto; height: 100%;">
                                            <li>
                                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="app-list-item hover-white">
                                            ...
                                            <li class="w-100">
                                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="btn btn-default mt-4 mb-2 pr-5 pl-5 waves-effect waves-themed"> Add more apps </a>
                                            </li>
                            ...
                            <!-- app message -->
                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-icon" data-toggle="modal" data-target=".js-modal-messenger">
                                <i class="fal fa-globe"></i>
                                <span class="badge badge-icon">!</span>
                            </a>
                            <!-- app notification -->
                            <div>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="header-icon" data-toggle="dropdown" title="You got 11 notifications">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-clean" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#tab-messages" data-i18n="drpdwn.messages">Messages</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#tab-feeds" data-i18n="drpdwn.feeds">Feeds</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#tab-events" data-i18n="drpdwn.events">Events</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active p-3 text-center">
                                            <h5 class="mt-4 pt-4 fw-500">
                                                ...
                                                <small class="mt-3 fs-b fw-400 text-muted">
                                                    ...
                                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html">settings page</a>
                                                </small>
                                            </h5>
                                        </div>
                                        <div class="tab-pane" id="tab-messages" role="tabpanel">
                                            <div class="custom-scroll h-100">
                                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><ul class="notification" style="overflow: hidden; width: auto; height: 100%;">
                                                    <li class="unread">
                                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-flex align-items-center">
                                                    ...
                                                    <li class="unread">
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            ...
                                                            <div class="show-on-hover-parent position-absolute pos-right pos-bottom p-3">
                                                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="text-muted" title="delete"><i class="fal fa-trash-alt"></i></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                                                    Adison Lee <span class="fw-300 d-inline">replied to your video <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="fw-400"> Cancer Drug</a> </span>
                                                                </span>
                                                        ...
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="mr-1 mt-1" title="Cell A-0012">
                                                                        <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-7.png&#39;); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                                        <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-8.png&#39;); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                                        <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-11.png&#39;); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                    ...
                                                    <table class="table table-bordered table-calendar m-0 w-100 h-100 border-0">
                                                        <tbody><tr>
                                                            <th colspan="7" class="pt-3 pb-2 pl-3 pr-3 text-center">
                                                                <div class="js-get-date h5 mb-2">Friday, July 23, 2021</div>
                                                            </th>
                                                        </tr>
                                    ...
                                    <div class="py-2 px-3 bg-faded d-block rounded-bottom text-right border-faded border-bottom-0 border-right-0 border-left-0">
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="fs-xs fw-500 ml-auto">view all notifications</a>
                                    </div>
                                </div>
                            </div>
                            <!-- app user menu -->
                            <div>
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                            <div class="info-card-text">
                                    ...
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="dropdown-item" data-action="app-reset">
                                        <span data-i18n="drpdwn.reset_layout">Reset Layout</span>
                                    </a>
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="dropdown-item" data-toggle="modal" data-target=".js-modal-settings">
                                        <span data-i18n="drpdwn.settings">Settings</span>
                                    </a>
                                    <div class="dropdown-divider m-0"></div>
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="dropdown-item" data-action="app-fullscreen">
                                        <span data-i18n="drpdwn.fullscreen">Fullscreen</span>
                                        <i class="float-right text-muted fw-n">F11</i>
                                    </a>
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="dropdown-item" data-action="app-print">
                                    ...
                                    <div class="dropdown-multilevel dropdown-multilevel-left">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=fr" class="dropdown-item" data-action="lang" data-lang="fr">Français</a>
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=en" class="dropdown-item active" data-action="lang" data-lang="en">English (US)</a>
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=es" class="dropdown-item" data-action="lang" data-lang="es">Español</a>
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=ru" class="dropdown-item" data-action="lang" data-lang="ru">Русский язык</a>
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=jp" class="dropdown-item" data-action="lang" data-lang="jp">日本語</a>
                                            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html#?lang=ch" class="dropdown-item" data-action="lang" data-lang="ch">中文</a>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date">Friday, July 23, 2021</span></li>
                        </ol>
                        <div class="subheader">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/form_plugins_daterange_picker.html" class="btn btn-primary waves-effect waves-themed" data-toggle="modal" data-target="#default-example-modal">Show inside datepicker</a>
                                                </div>
                                            </div>
                                            <!-- modal -->
                    ...
                    <footer class="page-footer" role="contentinfo">
                        ...
                        <div>
                            <ul class="list-table m-0">
                                <li><a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/intel_introduction.html" class="text-secondary fw-700">About</a></li>
                                <li class="pl-3"><a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/info_app_licensing.html" class="text-secondary fw-700">License</a></li>
                                <li class="pl-3"><a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/info_app_docs.html" class="text-secondary fw-700">Documentation</a></li>
        ...
        <nav class="shortcut-menu d-none d-sm-block">
            ...
            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="menu-item btn waves-effect waves-themed" data-toggle="tooltip" data-placement="left" title="" data-original-title="Scroll Top">
                <i class="fal fa-arrow-up"></i>
            </a>
            <a href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/page_login.html" class="menu-item btn waves-effect waves-themed" data-toggle="tooltip" data-placement="left" title="" data-original-title="Logout">
                <i class="fal fa-sign-out"></i>
            </a>
            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="menu-item btn waves-effect waves-themed" data-action="app-fullscreen" data-toggle="tooltip" data-placement="left" title="" data-original-title="Full Screen">
                <i class="fal fa-expand"></i>
            </a>
            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="menu-item btn waves-effect waves-themed" data-action="app-print" data-toggle="tooltip" data-placement="left" title="" data-original-title="Print page">
                <i class="fal fa-print"></i>
            </a>
            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="menu-item btn waves-effect waves-themed" data-action="app-voice" data-toggle="tooltip" data-placement="left" title="" data-original-title="Voice command">
                    ...
                    <div class="dropdown-header bg-trans-gradient d-flex align-items-center w-100">
                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                            ...
                            <div class="info-card-text">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html">Send Email</a>
                                    <a class="dropdown-item" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html">Create Appointment</a>
                                    <a class="dropdown-item" href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html">Block User</a>
                                </div>
                            ...
                            <div class="flex-1 h-100 custom-scroll">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="w-100" style="overflow: hidden; width: auto; height: 100%;">
                                    <ul id="js-msgr-listfilter" class="list-unstyled m-0 js-list-filter">
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="tracey chang online">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="oliver kopyuv online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="dr john cook phd away">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney online">
                                                <div class="d-table-cell align-middle status status-success status-sm ">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="sarah mcbrook online">
                                                <div class="d-table-cell align-middle status status-success status-sm">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney offline">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney busy">
                                        ...
                                        <li>
                                            <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="d-table w-100 px-2 py-2 text-dark hover-white" data-filter-tags="ali amdaney inactive">
                    ...
                    <div class="modal-body p-0">
                        <div class="settings-panel">
                            ...
                            <div class="list" id="fh">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="header-function-fixed"></a>
                                <span class="onoffswitch-title">Fixed Header</span>
                                <span class="onoffswitch-title-desc">header is in a fixed at all times</span>
                            </div>
                            <div class="list" id="nff">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-fixed"></a>
                                <span class="onoffswitch-title">Fixed Navigation</span>
                                <span class="onoffswitch-title-desc">left panel is fixed</span>
                            </div>
                            <div class="list" id="nfm">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-minify"></a>
                                <span class="onoffswitch-title">Minify Navigation</span>
                                <span class="onoffswitch-title-desc">Skew nav to maximize space</span>
                            </div>
                            <div class="list" id="nfh">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-hidden"></a>
                                <span class="onoffswitch-title">Hide Navigation</span>
                                <span class="onoffswitch-title-desc">roll mouse on edge to reveal</span>
                            </div>
                            <div class="list" id="nft">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-top"></a>
                                <span class="onoffswitch-title">Top Navigation</span>
                                <span class="onoffswitch-title-desc">Relocate left pane to top</span>
                            </div>
                            <div class="list" id="fff">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="footer-function-fixed"></a>
                                <span class="onoffswitch-title">Fixed Footer</span>
                                <span class="onoffswitch-title-desc">page footer is fixed</span>
                            </div>
                            <div class="list" id="mmb">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-main-boxed"></a>
                            ...
                            <div class="expanded">
                                ...
                                <div class="list" id="mbgf">
                                    <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-fixed-bg"></a>
                            ...
                            <div class="list" id="nmp">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-push"></a>
                                <span class="onoffswitch-title">Push Content</span>
                                <span class="onoffswitch-title-desc">Content pushed on menu reveal</span>
                            </div>
                            <div class="list" id="nmno">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-no-overlay"></a>
                                <span class="onoffswitch-title">No Overlay</span>
                                <span class="onoffswitch-title-desc">Removes mesh on menu reveal</span>
                            </div>
                            <div class="list" id="sldo">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-slide-out"></a>
                            ...
                            <div class="list" id="mbf">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-bigger-font"></a>
                                <span class="onoffswitch-title">Bigger Content Font</span>
                                <span class="onoffswitch-title-desc">content fonts are bigger for readability</span>
                            </div>
                            <div class="list" id="mhc">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-high-contrast"></a>
                                <span class="onoffswitch-title">High Contrast Text (WCAG 2 AA)</span>
                                <span class="onoffswitch-title-desc">4.5:1 text contrast ratio</span>
                            </div>
                            <div class="list" id="mcb">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-color-blind"></a>
                                <span class="onoffswitch-title">Daltonism <sup>(beta)</sup> </span>
                                <span class="onoffswitch-title-desc">color vision deficiency</span>
                            </div>
                            <div class="list" id="mpc">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-pace-custom"></a>
                                <span class="onoffswitch-title">Preloader Inside</span>
                                <span class="onoffswitch-title-desc">preloader will be inside content</span>
                            </div>
                            <div class="list" id="mpi">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-panel-icon"></a>
                            ...
                            <div class="list" id="mcbg">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-clean-page-bg"></a>
                                <span class="onoffswitch-title">Clean Page Background</span>
                                <span class="onoffswitch-title-desc">adds more whitespace</span>
                            </div>
                            <div class="list" id="mhni">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-hide-nav-icons"></a>
                                <span class="onoffswitch-title">Hide Navigation Icons</span>
                                <span class="onoffswitch-title-desc">invisible navigation icons</span>
                            </div>
                            <div class="list" id="dan">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-disable-animation"></a>
                                <span class="onoffswitch-title">Disable CSS Animation</span>
                                <span class="onoffswitch-title-desc">Disables CSS based animations</span>
                            </div>
                            <div class="list" id="mhic">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-hide-info-card"></a>
                                <span class="onoffswitch-title">Hide Info Card</span>
                                <span class="onoffswitch-title-desc">Hides info card from left panel</span>
                            </div>
                            <div class="list" id="mlph">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-lean-subheader"></a>
                                <span class="onoffswitch-title">Lean Subheader</span>
                                <span class="onoffswitch-title-desc">distinguished page header</span>
                            </div>
                            <div class="list" id="mnl">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-nav-link"></a>
                                <span class="onoffswitch-title">Hierarchical Navigation</span>
                                <span class="onoffswitch-title-desc">Clear breakdown of nav links</span>
                            </div>
                            <div class="list" id="mdn">
                                <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-nav-dark"></a>
                            ...
                            <div class="expanded theme-colors pl-5 pr-3">
                                <ul class="m-0">
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-0" data-action="theme-update" data-themesave="" data-theme="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wisteria (base css)"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-1" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-1.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tapestry"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-2" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-2.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Atlantis"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-3" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-3.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Indigo"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-4" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-4.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Dodger Blue"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-5" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-5.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tradewind"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-6" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-6.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cranberry"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-7" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-7.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Oslo Gray"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-8" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-8.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Chetwode Blue"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-9" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-9.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Apricot"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-10" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-10.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Blue Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-11" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-11.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Green Smoke"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-12" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-12.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wild Blue Yonder"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-13" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-13.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Emerald"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-14" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-14.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Supernova"></a>
                                    </li>
                                    <li>
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" id="myapp-15" data-action="theme-update" data-themesave="" data-theme="css/themes/cust-theme-15.css" data-toggle="tooltip" data-placement="top" title="" data-original-title="Hoki"></a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="mb-0 mt-4">
                            ...
                            <div class="pl-5 pr-3 py-3 bg-faded">
                                <div class="row no-gutters">
                                    <div class="col-6 pr-1">
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="btn btn-outline-danger fw-500 btn-block waves-effect waves-themed" data-action="app-reset">Reset Settings</a>
                                    </div>
                                    <div class="col-6 pl-1">
                                        <a href="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/form_plugins_daterange_picker.html" class="btn btn-danger fw-500 btn-block waves-effect waves-themed" data-action="factory-reset">Factory Reset</a>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/vendors.bundle.js.download"></script>
        <script src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/app.bundle.js.download"></script>
        <script src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/moment.js.download"></script>
        <script src="./Date Range Picker - Form Plugins - SmartAdmin v4.5.1_files/bootstrap-daterangepicker.js.download"></script>
        <script>
...
<div class="daterangepicker ltr show-calendar opensleft"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected">01/01/2018 - 01/15/2018</span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-calendar opensleft"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-calendar opensright"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-calendar opensright"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr single auto-apply opensright"><div class="ranges"></div><div class="drp-calendar left single" style="display: block;"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right" style="display: none;"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected">07/17/2020 - 07/17/2020</span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-ranges show-calendar opensright"><div class="ranges"><ul><li data-range-key="Today">Today</li><li data-range-key="Yesterday">Yesterday</li><li data-range-key="Last 7 Days">Last 7 Days</li><li data-range-key="Last 30 Days">Last 30 Days</li><li data-range-key="This Month">This Month</li><li data-range-key="Last Month">Last Month</li><li data-range-key="Custom Range">Custom Range</li></ul></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-success shadow-0" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-default shadow-0" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-ranges opensright"><div class="ranges"><ul><li data-range-key="Today">Today</li><li data-range-key="Yesterday">Yesterday</li><li data-range-key="Last 7 Days">Last 7 Days</li><li data-range-key="Last 30 Days">Last 30 Days</li><li data-range-key="This Month">This Month</li><li data-range-key="Last Month">Last Month</li><li data-range-key="Custom Range">Custom Range</li></ul></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Cancel</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div></body></html>