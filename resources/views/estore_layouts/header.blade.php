...
<header class="page-header" role="banner">
    ...
    <div class="hidden-md-down dropdown-icon-menu position-relative">
        <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="header-btn btn js-waves-off" data-action="toggle" data-class="nav-function-hidden" title="Hide Navigation">
            <i class="ni ni-menu"></i>
        </a>
        <ul>
            <li>
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="btn js-waves-off" data-action="toggle" data-class="nav-function-minify" title="Minify Navigation">
                    <i class="ni ni-minify-nav"></i>
                </a>
            </li>
            <li>
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="btn js-waves-off" data-action="toggle" data-class="nav-function-fixed" title="Lock Navigation">
    ...
    <div class="hidden-lg-up">
        <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="header-btn btn press-scale-down waves-effect waves-themed" data-action="toggle" data-class="mobile-nav-on">
            <i class="ni ni-menu"></i>
        </a>
    </div>
    <div class="search">
        <form class="app-forms hidden-xs-down" role="search" action="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/page_search.html" autocomplete="off">
            ...
            <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" onclick="return false;" class="btn-danger btn-search-close js-waves-off d-none" data-action="toggle" data-class="mobile-search-on">
    ...
    <div class="ml-auto d-flex">
        ...
        <div class="hidden-sm-up">
            <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="header-icon" data-action="toggle" data-class="mobile-search-on" data-focus="search-field" title="Search">
                <i class="fal fa-search"></i>
            </a>
        </div>
        <!-- app notification -->
        <div>
            <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="header-icon" data-toggle="dropdown" title="You got 11 notifications">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                ...
                <ul class="nav nav-tabs nav-tabs-clean" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/intel_analytics_dashboard.html#tab-messages" data-i18n="drpdwn.messages">Messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/intel_analytics_dashboard.html#tab-feeds" data-i18n="drpdwn.feeds">Feeds</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed" data-toggle="tab" href="https://www.gotbootstrap.com/themes/smartadmin/4.5.1/intel_analytics_dashboard.html#tab-events" data-i18n="drpdwn.events">Events</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane active p-3 text-center">
                        <h5 class="mt-4 pt-4 fw-500">
                            ...
                            <small class="mt-3 fs-b fw-400 text-muted">
                                ...
                                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html">settings page</a>
                            </small>
                        </h5>
                    </div>
                    <div class="tab-pane" id="tab-messages" role="tabpanel">
                        <div class="custom-scroll h-100">
                            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><ul class="notification" style="overflow: hidden; width: auto; height: 100%;">
                                <li class="unread">
                                    <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="d-flex align-items-center">
                                ...
                                <li class="unread">
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="show-on-hover-parent position-absolute pos-right pos-bottom p-3">
                                            <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="text-muted" title="delete"><i class="fal fa-trash-alt"></i></a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <div class="d-flex flex-column flex-1">
                                            <span class="name">
                                                Adison Lee <span class="fw-300 d-inline">replied to your video <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="fw-400"> Cancer Drug</a> </span>
                                            </span>
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <div class="d-flex flex-column flex-1">
                                            ...
                                            <div class="fs-sm d-flex align-items-center mt-1">
                                                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="mr-1 mt-1" title="Cell A-0012">
                                                    <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-7.png&#39;); background-size: cover;"></span>
                                                </a>
                                                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                    <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-8.png&#39;); background-size: cover;"></span>
                                                </a>
                                                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                    <span class="d-block img-share" style="background-image:url(&#39;img/thumbs/pic-11.png&#39;); background-size: cover;"></span>
                                                </a>
                                                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                ...
                                <table class="table table-bordered table-calendar m-0 w-100 h-100 border-0">
                                    <tbody><tr>
                                        <th colspan="7" class="pt-3 pb-2 pl-3 pr-3 text-center">
                                            <div class="js-get-date h5 mb-2">Tuesday, May 11, 2021</div>
                                        </th>
                                    </tr>
                ...
                <div class="py-2 px-3 bg-faded d-block rounded-bottom text-right border-faded border-bottom-0 border-right-0 border-left-0">
                    <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="fs-xs fw-500 ml-auto">view all notifications</a>
                </div>
            </div>
        </div>
        <!-- app user menu -->
        <div>
            <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="{{asset('img/avatar-admin.png') }}" class="profile-image rounded-circle" >
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                ...
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="dropdown-item" data-action="app-reset">
                    <span data-i18n="drpdwn.reset_layout">Reset Layout</span>
                </a>
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="dropdown-item" data-toggle="modal" data-target=".js-modal-settings">
                    <span data-i18n="drpdwn.settings">Settings</span>
                </a>
                <div class="dropdown-divider m-0"></div>
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="dropdown-item" data-action="app-fullscreen">
                    <span data-i18n="drpdwn.fullscreen">Fullscreen</span>
                    <i class="float-right text-muted fw-n">F11</i>
                </a>
                <a href="./Analytics Dashboard - Application Intel - SmartAdmin v4.5.1_files/intel_analytics_dashboard.html" class="dropdown-item" data-action="app-print">
                ...
                <div class="dropdown-multilevel dropdown-multilevel-left">
                    ...
                    <div class="dropdown-menu">
                        <a href="javascript:void(0)" class="dropdown-item" data-action="lang" data-lang="ch">中文</a>
                        <a href="javascript:void(0)" class="dropdown-item" data-action="lang" data-lang="en">English</a>
                    </div>
                </div>
                <div class="dropdown-divider m-0"></div>
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button class="dropdown-item fw-500 pt-3 pb-3">
                        ...
                        <span class="float-right fw-n">GOH JIA WEI</span>
                    </button>
                </form>
            </div>
        </div>
