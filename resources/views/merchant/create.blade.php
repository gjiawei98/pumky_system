            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <form action="{{ route('merchant.store') }}" name="merchant_form" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder="Merchant Name" value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="shipping_rate" name="shipping_rate" class="form-control"
                                            placeholder="Shipping Rate" value="{{ old('shipping_rate') }}">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select class="custom-select form-control" name="add_on" id="add_on"
                                                ...
                                                <option value="0">Bubble wrap</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telegram" name="telegram" class="form-control"
                                            placeholder="telegram Url" value="{{ old('telegram') }}">
                                    </div>
                                </div>
