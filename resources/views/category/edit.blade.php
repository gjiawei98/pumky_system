...
<div class="subheader">
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-book"></i> Edit Category
    </h1>
</div>
<div class="row">
    <div class="col-12">
        <form method="post" action="{{route('category.update',$category->id)}}" name="category_form" enctype="multipart/form-data" class="">
            @csrf
            @method('PUT')
            @if ($errors->any())
